...
ZVM_VI_HIGHLIGHT_BACKGROUND=#B48EAD

ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE='fg=#777777'

# set r rate 200 80
#
#export PS1='%F{blue}  %f%b%F{green}%3~ $(hg_prompt_info)$(git_prompt_info)%B%(!.%F{red}.%F{blue}) %f%b'
export PS1='%F{blue}  %f%b%F{#9494b8}%3~ %B%(!.%F{red}.%F{blue}) %f%b'
colorscript random
